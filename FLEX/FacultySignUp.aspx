    ...
    <form id="form1" runat="server">
       ...
       <div class="container-fluid">
         ...
         <div class="row" style="margin-left:200px;">
             ...
             <div class="col-md-12">
                 <br />
                   <asp:TextBox required='true' CssClass="transfot_form" placeholder="Gender" type="text" name="dept" ID ="dept" runat="server"></asp:TextBox>
             </div>
             <div class="col-md-12">
                 <br />
                   <asp:TextBox required='true' CssClass="transfot_form" placeholder="ofType" type="text" name="type" ID ="TextBox1" runat="server"></asp:TextBox>
             </div>
             <div class="col-md-12">
                 <br />
                   <asp:TextBox required='true' CssClass="transfot_form" placeholder="Password" type="text" name="pass" ID ="password" runat="server"></asp:TextBox>
             </div>
             <div class="col-md-12">
                 <br />
             ...
             <div class="col-md-12">
                 <br />
                   <h3>Aready signed up? Click to <asp:HyperLink runat="server" Text="LOGIN" ID="FacultyLogin"></asp:HyperLink></h3>
             </div>
