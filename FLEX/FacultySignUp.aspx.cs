...
public partial class AcademicSignUp : System.Web.UI.Page
{
    ...
    protected void btnSignup_Click(object sender, EventArgs e)
    {
        using (SqlConnection sqlCon = new SqlConnection("Data Source=ABDULLAHS-NOTEB" + "\\SQLEXPRESS;Initial Catalog=projectDatabase2;Integrated Security=True"))
        {
            ...
            string officerID = "I" + formattedNumber; // Combine the formatted number with the prefix "A"

            sqlCon.Open();

            string query = "INSERT INTO Instructor (InstructorID, FirstName, LastName, Email, Gender, ofType, Password) VALUES (@a0, @a1, @a2, @a3, @a4, @a5, @a6)";
            ...
            cm.Parameters.AddWithValue("@a5", TextBox1.Text);
